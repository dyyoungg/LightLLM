...
async def main():
    client = MultiModalClient(
        url="http://120.48.178.184:7918/generate_stream",
    ...
    print("=== 测试图像推理 ===")
    test_video = "/mnt/afs/yangdeyu/hRpeLQ1rApQ_7339235330479882240.mp4"
    ...
    print("\n\n=== 测试多模态推理 (图像+音频) ===")
    audios = ["/mnt/afs/yangdeyu/audio_ins_1.wav"]  # 音频文件路径
